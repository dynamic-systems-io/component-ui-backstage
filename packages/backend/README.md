...
This package is an EXAMPLE of a developer portal backend (Backstage-based).

The main purpose of this package is to provide a test bed for Backstage plugins in the developer portal
